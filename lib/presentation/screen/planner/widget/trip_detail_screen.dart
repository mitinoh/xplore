...
class TripDetailScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: CircleAvatar(
                      ...
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                              "https://107.174.186.223.nip.io/img/location/${planTrip.plannedLocation?[tripIdx].location?.id}.jpg",
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                        planTrip.plannedLocation?[tripIdx].location?.name ?? '',
            ...
            Row(
              ...
              children: [
                Text(
                    formatter.format(planTrip.plannedLocation?[tripIdx].date ??
                        DateTime.now()),
                    textAlign: TextAlign.center,
                    overflow: TextOverflow.ellipsis,
                    style: GoogleFonts.poppins(
  ...
  int getTripVisitDay(int tripIdx) {
    DateTime? tripDate = planTrip.plannedLocation?[tripIdx].date;
    int? differenceDays =
